	...
	var config = {
		...
		"tilesApi": {
			...
			"endpoints": {
				...
				"landsatNdwiTimeseries": "/api/timeseries/ndwi/landsat/{lat}/{lon}",
				"sentinelNdwiTimeseries": "/api/timeseries/ndwi/sentinel2/{lat}/{lon}",
				"modisNdwiTimeseries": "/api/timeseries/ndwi/modis/{lat}/{lon}",
