...
LANDSAT_5 = ee.ImageCollection("LANDSAT/LT5_L1T_TOA_FMASK");
LANDSAT_7 = ee.ImageCollection("LANDSAT/LE7_L1T_TOA_FMASK");
LANDSAT_8 = ee.ImageCollection("LANDSAT/LC8_L1T_TOA_FMASK");
