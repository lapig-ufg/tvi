...
const getInfoByRegionCmd = function(coordinate) {
	...
	sql = "select json_group_array(json_object( 'id', id_region, 'biome', reg_clasif, 'country', pais )) from region_clasificacion where ST_INTERSECTS(Geometry,GeomFromText('POINT("+coordinate.X+" "+coordinate.Y+")',4326))"
